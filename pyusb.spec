...
Source0  : https://files.pythonhosted.org/packages/b8/5a/d5d54813eb18ca8d0a03c51c5248c8564d422b4c35a9b7b0fd1b4f1b8154/pyusb-1.2.0.tar.gz
...
%prep
%setup -q -n pyusb-1.2.0
cd %{_builddir}/pyusb-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625588407
...
cp %{_builddir}/pyusb-1.2.0/LICENSE %{buildroot}/usr/share/package-licenses/pyusb/db7a78de40a2b6d5a57d10bbb3d3e0ad89b1f9c6
